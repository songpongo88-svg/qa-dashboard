...
const marker = "final-signed-current-kpi-restore-v17";
...
if (!source.includes(marker)) {
  if (!source.includes("final-signed-current-score-color-v16")) {
    throw new Error("Current score color v16 must run before v17");
  }
