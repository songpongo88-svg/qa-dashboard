  ...
  return {
    ...
    transform(code, id) {
      ...
      next = replaceOrThrow(
        ...
        `                              คะแนนเฉลี่ยรายหัวข้อเทียบกับเกณฑ์ KPI {getPerformanceKpiTarget(overviewMonthKey)}%`,
