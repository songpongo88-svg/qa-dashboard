...
const JUNE_FOCUS_TABLE_ROWS = [
  {
    ...
    reviewGuide:
      "ดูว่าแอดมินเริ่มแชทและจบแชทถูกต้องหรือไม่ เช่น ทักทาย แนะนำตัว แจ้งว่าพร้อมช่วยเหลือ และปิดแชทเมื่อให้ข้อมูลครบแล้ว โดยควรระบุชื่อแอดมินตามมาตรฐานอย่างน้อย 2 ครั้ง และไม่รีบปิดเคสก่อนผู้ติดต่อได้คำตอบครบ",
    examples:
      "ไม่ทักทายหรือไม่แนะนำตัว, ไม่มีข้อความปิดแชท, ระบุชื่อแอดมินไม่ครบ, ปิดเคสเร็วเกินไป, ปิดแชททั้งที่ผู้ติดต่อยังต้องการความช่วยเหลือ",
  },
  {
    categoryCode: "1",
    category: "ขั้นตอนการทำงานและนโยบาย (Process & Policy Compliance)",
    ...
    reviewGuide:
      "ดูว่าแอดมินขอข้อมูล ใช้ข้อมูล และแจ้งข้อมูลตาม PDPA และนโยบายบริษัทหรือไม่ ควรขอเฉพาะข้อมูลที่จำเป็น ยืนยันตัวตนหรือยืนยันข้อมูลตามประเภทเคส และไม่เปิดเผยข้อมูลของคนอื่นเกินความจำเป็น",
    examples:
      "ขอข้อมูลเกินจำเป็น, เปิดเผยข้อมูลของผู้อื่น, ไม่ยืนยันข้อมูลในเคสที่ต้องตรวจสอบ, แจ้งข้อมูลขัดกับนโยบาย, ใช้ข้อมูลส่วนบุคคลไม่เหมาะกับเคส",
  },
  {
    categoryCode: "1",
    category: "ขั้นตอนการทำงานและนโยบาย (Process & Policy Compliance)",
    ...
    reviewGuide:
      "ดูว่าแอดมินทำตามขั้นตอนและเวลาที่กำหนดหรือไม่ เช่น รับแชท ตอบกลับ ปิดแชทในเวลาที่เหมาะสม โทรออกหรือประสานงานตาม Process ส่งต่อถูกทีม และปิดเคสในจังหวะที่ให้ข้อมูลหรือแจ้งขั้นตอนต่อครบแล้ว",
    examples:
      "ไม่ทำตาม Process, รับแชทเกิน SLA, ตอบช้าโดยไม่มีเหตุผล, ปิดแชทเกินเกณฑ์ ATH, ไม่โทรออกตามเงื่อนไข, ส่งต่อผิดทีม, ส่งต่อข้อมูลไม่ครบ, ปิดเคสเร็วเกินไปหรือปิดทั้งที่ยังไม่มีแนวทางต่อ",
  },
  {
    categoryCode: "1",
    category: "ขั้นตอนการทำงานและนโยบาย (Process & Policy Compliance)",
    ...
    reviewGuide:
      "ดูว่าแอดมินบันทึกเคสใน Support Center ครบและถูกต้องหรือไม่ ต้องเลือก Tag ให้ตรงเรื่อง ใส่ข้อมูลสำคัญที่จำเป็น เช่น เลขออเดอร์ Shop ID MID RR เบอร์โทรศัพท์ หรือข้อมูลอ้างอิง และสรุปสิ่งที่ตรวจสอบหรือดำเนินการแล้วให้ทีมถัดไปเข้าใจได้",
    examples:
      "ไม่บันทึกเคส, ไม่ใส่ Tag, ใส่ Tag ไม่ตรงเรื่อง, Case Note ไม่ครบหรือคลุมเครือ, ไม่ใส่ข้อมูลสำคัญ, ทีมถัดไปอ่านแล้วตามงานต่อได้ยาก",
  },
  {
    categoryCode: "2",
    ...
    reviewGuide:
      "ดูว่าคำตอบถูกต้อง ตรงกับประเภทผู้ติดต่อ เช่น ลูกค้า ไรเดอร์ หรือร้านค้า และตอบครบทุกคำถามที่ผู้ติดต่อถาม ทั้งคำถามหลัก คำถามต่อเนื่อง และข้อมูลที่จำเป็นต่อการตัดสินใจ ไม่ทำให้ต้องถามซ้ำในเรื่องเดิม",
    examples:
      "แจ้งเงื่อนไขผิด, แจ้งสถานะหรือยอดเงินผิด, ใช้ข้อมูลเก่าหรือไม่ตรงปัจจุบัน, ตอบไม่ตรงประเภทผู้ติดต่อ, ตอบไม่ครบ, ข้ามคำถามหลัก, ทำให้ผู้ติดต่อเข้าใจผิด",
  },
  {
    categoryCode: "2",
    category: "คุณภาพคำตอบและการวิเคราะห์ปัญหา (Answer Quality & Problem Analysis)",
    ...
    reviewGuide:
      "ดูว่าแอดมินขอข้อมูลที่จำเป็นและตรวจสอบก่อนตอบหรือไม่ เช่น ตรวจระบบ ประวัติเคส รายละเอียดออเดอร์ หลักฐานจากผู้ติดต่อ หรือข้อมูลประกอบอื่น ๆ และวิเคราะห์สาเหตุให้ตรงปัญหา ไม่ด่วนสรุปจากข้อมูลที่ยังไม่พอ",
    examples:
      "ยังไม่ขอเลขออเดอร์/เบอร์/โค้ดแต่สรุปคำตอบทันที, ตรวจสอบข้อมูลไม่ครบ, วิเคราะห์ผิดประเด็น, มองข้ามหลักฐานที่ผู้ติดต่อส่งมา, ตอบจากการคาดเดา",
  },
  {
    categoryCode: "3",
    ...
    reviewGuide:
      "ดูว่าแอดมินรับเรื่องแล้วดูแลต่อเนื่องหรือไม่ ไม่ตอบแล้วปล่อย ไม่โยนภาระให้ผู้ติดต่อโดยไม่จำเป็น และทำให้ผู้ติดต่อมั่นใจว่าเรื่องได้รับการดูแลจนมีข้อสรุปหรือมีทางไปต่อ",
    examples:
      "รับเรื่องแล้วไม่ดำเนินการต่อ, ให้ผู้ติดต่อจัดการเองทั้งที่ควรช่วยตรวจสอบ, ไม่สรุปว่าเคสอยู่ขั้นตอนไหน, ทำให้ผู้ติดต่อไม่รู้ว่าเรื่องได้รับการดูแลแล้วหรือยัง",
  },
  {
    categoryCode: "3",
    category: "การดูแลเคสและติดตามผล (Case Handling & Follow-up)",
    ...
    reviewGuide:
      "ดูว่าแอดมินบอกขั้นตอนถัดไปชัดหรือไม่ เช่น ต้องรออะไร รอนานแค่ไหน ต้องส่งข้อมูลอะไรเพิ่ม หรือทีมไหนจะดำเนินการต่อ เพื่อให้ผู้ติดต่อรู้ว่าหลังจากนี้ต้องทำอะไร",
    examples:
      "ไม่มีขั้นตอนถัดไป, แจ้งให้รอแต่ไม่บอกระยะเวลา, ไม่บอกว่าต้องส่งข้อมูลอะไรเพิ่ม, ไม่แจ้งช่องทางติดตามผล, แจ้งกว้างเกินไปจนทำต่อไม่ได้",
  },
  {
    categoryCode: "3",
    category: "การดูแลเคสและติดตามผล (Case Handling & Follow-up)",
    ...
    reviewGuide:
      "ดูว่าเมื่อแอดมินตรวจระบบ โทรออก ประสานงาน หรือส่งต่อแล้ว มีการสรุปผลกลับมาในแชทหรือไม่ ควรบอกว่าพบอะไร ทำอะไรไปแล้ว และสถานะล่าสุดเป็นอย่างไร",
    examples:
      "ตรวจสอบแล้วแต่ไม่แจ้งผล, โทรออกหรือประสานงานแล้วไม่สรุป, มีการติดต่อกลับแต่ไม่บอกข้อสรุป, แจ้งผลไม่ครบจนผู้ติดต่อต้องถามซ้ำ",
  },
  {
    categoryCode: "4",
    ...
    reviewGuide:
      "ดูว่าข้อความอ่านเข้าใจง่ายหรือไม่ ควรเรียงจากรับเรื่อง → ตรวจสอบ/แจ้งผล → บอกขั้นตอนถัดไป แยกประเด็นให้ชัด ไม่เขียนรวมกันจนผู้ติดต่อสับสน",
    examples:
      "ข้อความยาวติดกัน, ลำดับสลับ, หลายประเด็นปนกัน, อ่านแล้วไม่รู้ว่าต้องทำอะไรก่อน, จุดสำคัญไม่ชัด",
  },
  {
    categoryCode: "4",
    category: "ทักษะการสื่อสาร (Communication Skills)",
    ...
    reviewGuide:
      "ดูว่าคำตอบสั้นพอดี ตรงคำถาม และเข้าใจได้ทันทีหรือไม่ ควรให้ข้อมูลที่จำเป็นครบ โดยไม่วกวน ไม่ใส่ข้อมูลที่ไม่เกี่ยว และไม่ใช้คำซ้ำจนเยิ่นเย้อ",
    examples:
      "ตอบยาวเกินจำเป็น, ใช้คำฟุ่มเฟือย, ตอบไม่ตรงคำถาม, ใส่ข้อมูลไม่เกี่ยวกับปัญหา, ใช้ประโยคซ้ำจนข้อความเยิ่นเย้อ",
  },
  {
    categoryCode: "4",
    category: "ทักษะการสื่อสาร (Communication Skills)",
    ...
    reviewGuide:
      "ดูคำสะกด การเว้นวรรค ไวยากรณ์ และการเลือกใช้คำให้เหมาะกับงานบริการ ข้อความต้องอ่านลื่น ไม่ทำให้ความหมายเพี้ยน และเรียกผู้ติดต่อให้ถูกประเภท เช่น คุณลูกค้า พี่ไรเดอร์ หรือร้านค้า",
    examples:
      "สะกดผิดหลายจุด, เว้นวรรคผิดจนอ่านยาก, ใช้คำผิดความหมาย, เรียกผู้ติดต่อผิดประเภท, ภาษาทำให้เข้าใจผิด",
  },
  {
    categoryCode: "4",
    category: "ทักษะการสื่อสาร (Communication Skills)",
    ...
    reviewGuide:
      "ดูว่าการใช้ภาษาและโทนการตอบเหมาะกับสถานการณ์หรือไม่ โดยเฉพาะเคสที่ผู้ติดต่อกังวล ร้องเรียน หรือได้รับผลกระทบ ควรแสดงความเข้าใจ ให้ความมั่นใจ และเมื่อผู้ติดต่อส่งข้อมูลหรือหลักฐานมา ควรตอบรับและบอกว่าจะนำไปตรวจสอบต่อ",
    examples:
      "ตอบแข็งหรือห้วน, ไม่แสดงความเข้าใจในเคสที่มีผลกระทบ, ใช้คำไม่เหมาะกับสถานการณ์, ผู้ติดต่อส่งข้อมูลแล้วไม่รับทราบ, ไม่บอกว่าจะนำข้อมูลไปทำอะไรต่อ",
  },
];
