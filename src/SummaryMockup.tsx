...
function getGradePolicyLabel(monthKey: string) {
  ...
  if (monthKey === "2026-02") return "February 2026 policy · Cash only";
  if (monthKey === "2026-03") return "March 2026 policy · Cash only";
  if (monthKey === "2026-04") return "April 2026 policy · Cash + RBH Promo";
  return "Current monthly grade policy · Cash only";
}
...
function AnalyticsAgentPerformanceV92({
  ...
  return (
    ...
    >
      ...
      <div
        data-monthly-grade-criteria-v105="true"
      ...
      >
          ...
          <div className="mt-5 overflow-hidden rounded-2xl border border-violet-100">
            {getGradeGuideRows(monthKey).map((row) => {
              ...
              return (
                <div
                  key={row.grade}
                  className="border-b border-violet-100 bg-white px-3 py-3 last:border-b-0"
                >
                  <div className="grid grid-cols-[42px_minmax(0,1fr)_minmax(110px,auto)] items-center gap-3">
                    <span
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 pl-[54px]">
                    <div className="rounded-xl border border-emerald-100 bg-emerald-50/70 px-3 py-2">
                      ...
                      <div className="mt-1 text-xs font-semibold text-emerald-800">
                        {incentive.cash > 0
                          ? formatCurrencyTHB(incentive.cash)
                          : "No Incentive"}
                      </div>
                    </div>
        ...
        <div className="mt-4 text-[10px] font-normal leading-5 text-slate-500">
          Cash Incentive and RBH Promo Code follow the original monthly policy. RBH Promo applies only to January 2026 and April 2026.
        </div>
      </div>
    </div>
  );
