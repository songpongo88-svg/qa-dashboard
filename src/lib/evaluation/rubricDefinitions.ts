...
export const APR_2026_TOPICS: RubricTopicDefinition[] = [
  {
    ...
    boundaryRule: "ไม่ใช้หักเรื่องข้อมูลผิดหรือข้อมูลไม่ครบ และไม่ใช้หักเรื่อง tone แข็ง"
  },
  {
    rubricVersion: "APR_2026",
    topicCode: "1.2",
  ...
  },
  {
    ...
    boundaryRule: "ข้อนี้เน้นถูกหรือผิด ถ้าถูกแต่ยังตอบไม่ครบ ให้ไปที่ 2.2"
  },
  {
    rubricVersion: "APR_2026",
    topicCode: "2.2",
  ...
  },
  {
    ...
    boundaryRule: "ข้อนี้เน้นการคิดและการแก้ปัญหา ไม่ใช้หักเรื่องความสุภาพหรือรูปแบบภาษา"
  },
  {
    rubricVersion: "APR_2026",
    topicCode: "3.2",
    ...
    boundaryRule: "ถ้าปัญหาคือ flow ผิด ให้หักที่ 1.3 ถ้าปัญหาคือแก้ปัญหาไม่ตรง ให้หักที่ 3.1"
  },
  {
    rubricVersion: "APR_2026",
    topicCode: "4.1",
  ...
  },
  {
    ...
    topicGroup: "Communication",
    maxScore: 5,
    focus: "ประเมินคุณภาพของภาษาเขียน ความสุภาพ ความชัดเจน และความเหมาะสมกับบริบทแอปเดลิเวอรี",
    practicalCheckpoints: [
    ...
    boundaryRule: "ข้อนี้เน้นภาษาเขียน ไม่ใช้หักเรื่อง tone เชิงอารมณ์ ให้ไปที่ 4.3"
  },
  {
    rubricVersion: "APR_2026",
    topicCode: "4.3",
    ...
    topicGroup: "Communication",
    maxScore: 10,
    focus: "ประเมินโทนการสื่อสารและความรู้สึกที่ผู้รับบริการได้รับ ทั้งจากข้อความและจากเสียง หากมีการโทรออก",
    practicalCheckpoints: [
    ...
    boundaryRule: "ถ้าปัญหาคือสะกดหรือภาษาวกวน ให้หักที่ 4.2 ถ้าปัญหาคือความรู้สึกจาก tone ให้หักที่ 4.3"
  }
];
