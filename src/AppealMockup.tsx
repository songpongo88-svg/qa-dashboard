...
const APPEAL_CASES: AppealCase[] = [
    ...
    items: [
      {
        ...
        after: '4/5',
        result: 'คงเดิม 4/5',
        agentAppeal: 'ไม่สามารถแจ้งข้อมูลรายละเอียดเพิ่มเติมได้ตามนโยบาย',
        reason: 'แม้จะไม่สามารถแจ้งรายละเอียดเชิงลึกได้ แต่ยังควรอธิบายกรอบกว้าง ๆ ให้ผู้ติดต่อเข้าใจได้มากขึ้นว่าผลการตรวจสอบเป็นไปตามนโยบายบริษัทและไม่สามารถดำเนินการเปิดระบบให้ได้',
        guidance:
          'จากการตรวจสอบ บัญชีของพี่ไรเดอร์ยังไม่สามารถเปิดใช้งานได้ครับ เนื่องจากผลตรวจสอบไม่เป็นไปตามเงื่อนไขของนโยบายบริษัทครับ',
      },
      {
        ...
        after: '2/5',
        result: 'คงเดิม 2/5',
        agentAppeal: 'ไม่สามารถให้ข้อมูลการอุทธรณ์หรือคำแนะนำเพิ่มเติมได้ตามนโยบาย',
        reason: 'ในระดับงานบริการยังสามารถอธิบายให้ชัดขึ้นได้ว่าเป็นผลการตรวจสอบตามนโยบายของบริษัท และไม่สามารถดำเนินการต่อได้',
        guidance: 'ผลการตรวจสอบเป็นไปตามนโยบายของบริษัท จึงไม่สามารถดำเนินการต่อได้ครับ',
      },
      {
        ...
        after: '6/10',
        result: 'คงเดิม 6/10',
        agentAppeal: 'ไม่สามารถแจ้งรายละเอียดหรือแนวทางเพิ่มเติมได้ตามนโยบาย',
        ...
        guidance: 'ผลพิจารณาของบัญชีไม่เป็นไปตามเงื่อนไขของบริษัท จึงยังไม่สามารถดำเนินการเปิดระบบให้ได้ครับ',
      },
      {
        ...
        after: '4/5',
        result: 'คงเดิม 4/5',
        agentAppeal: 'ไม่สามารถแจ้งข้อมูลการอุทธรณ์ได้',
        reason: 'ยังไม่ได้ดูแลต่อยอดในมุมความต้องการของไรเดอร์หรือปิดบทสนทนาเชิงบริการให้ชัดเจนพอ',
        guidance: 'หากมีข้อมูลที่บริษัทสามารถแจ้งเพิ่มเติมได้ แอดมินจะแจ้งให้ทราบตามขั้นตอนครับ',
      },
      {
        ...
        after: '2/5',
        result: 'คงเดิม 2/5',
        agentAppeal: 'ไม่สามารถให้แนวทางเพิ่มเติมได้ตามนโยบาย',
        reason: 'แม้จะไม่สามารถเปิดทางเชิงอุทธรณ์ได้ แต่ยังสามารถแจ้งให้ชัดว่าผลการพิจารณาสิ้นสุดตามนโยบายบริษัทหรือไม่มีขั้นตอนเพิ่มเติมแล้ว',
  ...
  },
  {
    ...
    summary:
      'จากการทบทวนอีกครั้ง คำอุทธรณ์ช่วยให้เห็นบริบทของเคสชัดขึ้นว่า Agent มีการให้ข้อมูลเพิ่มเติมแก่ไรเดอร์ มีการติดต่อไรเดอร์ และมีการแจ้งแนวทางให้ติดต่อกลับหากยังพบปัญหา จึงเห็นควรปรับคะแนนบางหัวข้อ ได้แก่ 3.2, 3.3 และ 5.1 ขณะที่หัวข้อ 3.1 ยังคงคะแนนเดิม',
    submissionChannel: 'Email',
    submissionEmail: 'Natcha@robinhood.co.th',
    appealClosedNotice: DEFAULT_NOTICE,
    items: [
      {
        ...
        after: '4/10',
        result: 'คงเดิม 4/10',
        agentAppeal: 'มีการให้ข้อมูลไรเดอร์เพิ่มเติมและติดตามต่อเนื่อง',
        reason: 'ยังไม่พบการวิเคราะห์สาเหตุของความล่าช้าหรือปัญหาที่เกิดขึ้นอย่างชัดเจน รวมถึงแนวทางแก้ไขเชิงรุกที่ควรดำเนินการทันที',
        guidance:
          'หากยังหาร้านไม่พบ แนะนำให้ติดต่อร้านทันที ตรวจสอบจุดสังเกตเพิ่มเติม และหากยังมีปัญหาอยู่สามารถแจ้งแอดมินกลับเข้ามาได้อีกครั้งครับ',
      },
      {
        topic: '3.2 Case Ownership',
        before: '2/5',
        ...
        agentAppeal: 'มีการติดตามและให้ข้อมูลเพิ่มเติมแก่ไรเดอร์จริง',
        ...
        guidance: 'หากยังพบปัญหาเกี่ยวกับร้านค้าหรือการจัดส่ง แอดมินจะช่วยประสานงานเพิ่มเติมให้ตามความเหมาะสมครับ',
      },
      {
        topic: '3.3 Clear Next Step Guidance',
        before: '3/5',
        ...
        agentAppeal: 'แจ้งไว้แล้วว่าหากยังพบปัญหาสามารถแจ้งแอดมินเพิ่มเติมได้',
        reason: 'มีการแจ้งแนวทางถัดไปให้ไรเดอร์ค่อนข้างชัดเจนและสามารถนำไปปฏิบัติได้จริง',
      ...
      },
      {
        ...
        agentAppeal: 'มีการให้ข้อมูลเพิ่มเติม ติดตามไรเดอร์ และแจ้งแนวทางแก้ไขก่อนจบการสนทนา',
        reason: 'สะท้อนการปฏิบัติตามกระบวนการในระดับหนึ่ง แต่ยังไม่พบการดำเนินการครบทุกขั้นตอนของ flow อย่างชัดเจน',
        guidance:
          'หากพบปัญหาต่อเนื่องหรือมีผลกระทบกับออเดอร์เพิ่มเติม ควรตรวจสอบเชิงระบบและดำเนินการตาม flow ต่อให้ครบถ้วนครับ',
      },
    ],
  },
  {
    ...
    summary:
      'หัวข้อ 1.2 ไม่ได้ปรับคะแนน เพราะแม้ข้อเท็จจริงเรื่องร้านค้าเตรียมอาหารจะถูกต้อง แต่การสื่อสารของ Agent ยังไม่ชัดเจนตามลำดับที่ควรเป็น และมีลักษณะคล้ายเปิดทางให้ไรเดอร์ระบุเหตุผลเพื่อยกเลิกก่อน ส่วนหัวข้อ 4.3 ไม่ได้ปรับคะแนน เพราะยังไม่พบถ้อยคำที่แสดงความเข้าใจหรือ Empathy ต่อสถานการณ์ของไรเดอร์อย่างเหมาะสม',
    submissionChannel: 'Email',
    ...
    items: [
      {
        ...
        agentAppeal: 'ตรวจสอบแล้วพบว่าร้านค้าได้จัดเตรียมอาหารแล้ว',
        reason: 'แม้ข้อเท็จจริงบางส่วนถูกต้อง แต่การสื่อสารยังไม่ครบถ้วนและไม่เป็นไปตามลำดับที่เหมาะสม',
        guidance: 'แอดมินจะประสานงานจัดหาไรเดอร์ทดแทนเพื่อเข้ารับและจัดส่งอาหารต่อค่ะ',
      },
      {
        ...
        after: '3/5',
        result: 'ไม่ปรับคะแนน คงเดิม 3/5',
        agentAppeal: 'สอบถามว่าจำเป็นต้องกล่าวขอโทษหรือไม่',
        reason:
          'หัวข้อนี้พิจารณาความเหมาะสมของน้ำเสียงโดยรวมและการแสดงความเข้าใจต่อสถานการณ์ของผู้ติดต่อ ซึ่งยังไม่ชัดเจนเพียงพอ',
  ...
  },
  {
    ...
    summary:
      'เคสนี้เป็นเคสต่อเนื่องจริง แต่เมื่อพิจารณาตามมาตรฐาน QA แล้ว ยังไม่พบเหตุเพียงพอให้ปรับเพิ่มคะแนนในหัวข้อที่อุทธรณ์ เนื่องจากข้อความที่สื่อสารกับไรเดอร์ยังขาดองค์ประกอบสำคัญหลายจุด',
    submissionChannel: 'Email',
  ...
  },
  {
    ...
    summary:
      'พิจารณาแล้วรับอุทธรณ์บางส่วน โดยปรับคะแนนหัวข้อ 2.4, 3.3 และ 5.1 ส่วนหัวข้อ 3.1 ยังคงเดิม เนื่องจากแม้เป็นเคสต่อเนื่อง แต่ยังควรมีการสรุปสถานะปัจจุบันให้ลูกค้าเข้าใจชัดเจนในช่วงที่รับเคสต่อ',
    submissionChannel: 'Email',
    submissionEmail: 'Nattapol.s@robinhood.co.th',
    appealClosedNotice: DEFAULT_NOTICE,
    items: [
  ...
  },
  {
    ...
    summary:
      'ตามที่ Agent ได้ยื่นอุทธรณ์ผลการประเมิน QA ของเคส AA207397 ทางผู้ประเมินได้ทบทวนบทสนทนาและเหตุผลประกอบแล้ว เห็นควรปรับคะแนนบางหัวข้อ โดยหัวข้อ 1.2 และ 2.2 ปรับเป็น 3/5, หัวข้อ 3.1 ปรับเป็น 4/10 และหัวข้อ 3.3 ปรับเป็น 3/5 ส่วนหัวข้ออื่นคงคะแนนเดิม',
    submissionChannel: 'Email',
    submissionEmail: 'Nattapol.s@robinhood.co.th',
    appealClosedNotice: DEFAULT_NOTICE,
    items: [
  ...
  },
  {
    ...
    summary:
      'หัวข้อ 3.1 เห็นควรปรับจาก 3/10 เป็น 5/10 เนื่องจาก Agent มีการตรวจสอบข้อมูลก่อนตอบจริง ส่วนหัวข้อ 4.2 เห็นควรปรับจาก 4/5 เป็น 5/5 เพราะคอมเมนต์เดิมเป็นเชิงบวกครบองค์ประกอบ',
    submissionChannel: 'Email',
    submissionEmail: 'Nattapol.s@robinhood.co.th',
    appealClosedNotice: DEFAULT_NOTICE,
    items: [
  ...
  },
  {
    ...
    summary:
      'Agent ให้ข้อมูลถูกต้องตามข้อเท็จจริงของระบบในประเด็นหลัก แต่หัวข้อที่ถูกหักเป็นเรื่องความชัดเจนในการสรุปคำตอบให้ตรงคำถาม และการช่วยต่อยอดแนวทางใช้งานให้ร้านค้านำไปใช้ได้จริง',
    submissionChannel: 'Email',
  ...
  },
  {
    ...
    summary:
      'ไม่แนะนำให้ปรับคะแนนในประเด็นที่ยื่นอุทธรณ์ เพราะเหตุผลที่ Agent ชี้แจงเป็นเรื่องการดำเนินการภายในเป็นหลัก แต่จุดที่ถูกหักในผลประเมินเดิมเป็นเรื่องคุณภาพของการสื่อสารในแชท ซึ่งยังไม่ครบและไม่ชัดในบางประเด็น',
    submissionChannel: 'Email',
    submissionEmail: 'Jariyawadee@robinhood.co.th',
    appealClosedNotice: DEFAULT_NOTICE,
    items: [
  ...
  },
  {
    ...
    summary:
      'เคสนี้ยังสามารถนำมาประเมิน QA ได้ แม้จะเป็นแชทติดตามผลจากเคสเดิม แต่ยังคงเป็นการสื่อสารกับไรเดอร์จริง และยังมีผลต่อคุณภาพการให้บริการ จึงเห็นควรปรับคะแนนบางหัวข้อขึ้นเล็กน้อย',
    submissionChannel: 'Email',
